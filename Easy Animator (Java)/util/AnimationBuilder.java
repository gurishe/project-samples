...
/**
 * This is an interface representing a builder that will take some input from somewhere and parse it
 * into a fully populated EasyAnimatorModel class.
 * @param <Doc> is simply the interface name of the EasyAnimatorModel implementation which is
 *             EasyAnimatorModel for me.
 */
